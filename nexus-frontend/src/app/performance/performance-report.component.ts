...
@Component({
  ...
  styles: [`
    ...
    .survey-form { display: flex; flex-direction: column; gap: 1.75rem; }
    ...
    .question-row label { display: block; margin-bottom: 1rem; font-weight: 600; font-size: 1rem; color: #1e293b; }

    .rating-options { display: grid; grid-template-columns: repeat(5, 1fr); gap: 0.5rem; }

    .rating-btn { position: relative; cursor: pointer; }
    .rating-btn input { position: absolute; opacity: 0; width: 0; height: 0; }
    .rating-btn span {
      display: flex;
      align-items: center;
    ...
    .period-display { font-size: 1.1rem; font-weight: 700; color: #1e293b; text-align: center; pointer-events: none; }
    ...
    .filter-group input, .filter-group select { padding: 0.5rem; border-radius: 0.4rem; border: 1px solid #cbd5e1; }

    .table-container { background: white; border-radius: 1rem; overflow: hidden; box-shadow: 0 10px 15px -3px rgb(0 0 0 / 0.1); }

    .report-table { width: 100%; border-collapse: collapse; text-align: left; }
    .report-table th { background: #f8fafc; padding: 1rem; font-weight: 600; font-size: 0.875rem; color: #64748b; border-bottom: 1px solid #e2e8f0; }
    ...
    .rating-cell { display: flex; align-items: center; gap: 1rem; }
    .stars { color: #e2e8f0; }
    ...
    .modal-content header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; }
    ...
    .detail-item span { font-weight: 700; font-size: 1.1rem; }
